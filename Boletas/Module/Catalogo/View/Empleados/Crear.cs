...
namespace Boletas.Module.Catalogo.View.Empleados
{
    public partial class Crear : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string agregar = "insert into empleados values ('" + txtNombre.Text + "','" + txtAP.Text + "','" + txtAM.Text + "','" + txtPuesto.Text + "'," + txtTelefono.Text + ",'" + txtEmail.Text + "','" + txtDireccion.Text + "'," + estatus + ")";
