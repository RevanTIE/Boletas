...
namespace Boletas.Module.Catalogo.View.Parroco
{
    public partial class Modificar : Form
    {
        ...
        public void ModificarParroco(string idParroco)
        {
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                string actualizar = "update parroco set nombre = '" + txtNombre.Text + "', apellidoPaterno = '" + txtAP.Text + "', apellidoMaterno = '" + txtAM.Text + "', telefono = " + txtTelefono.Text +
